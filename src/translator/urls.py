from django.contrib.auth import views as auth_views  # Імпортуємо вбудовані представлення
...
urlpatterns = [
    ...
    path("download/<uuid:record_id>/<str:file_type>/", download_file_view, name="download_file"),
